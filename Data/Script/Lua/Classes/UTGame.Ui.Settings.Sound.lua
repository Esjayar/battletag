...
function UTGame.Ui.Settings.Sound:__ctor()
	...
	UTGame.Ui.Settings.Sound.options = UTGame.Ui.Settings.Sound.options or {
        ...
        [4] = { displayMode = "multiline", tip = l"tip105", label = l "sett013", choices = { { value = 16, displayMode = "large", text = "Off"  }, { value = 4, displayMode = "large", text = l"oth052" }, { value = 1, displayMode = "large", text = l"oth053" }, { value = 0, displayMode = "large", text = l"oth054" }}, index = "l-volume:blaster", },
    ...
    for i, option in ipairs(UTGame.Ui.Settings.Sound.options) do
		...
		self.uiOption:MoveTo(50, -30 + i * 70)
