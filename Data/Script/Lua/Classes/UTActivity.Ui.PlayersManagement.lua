...
function UTActivity.Ui.PlayersManagement:OnClose()
    ...
    for index, proxy in ipairs(engine.libraries.usb.proxies) do
		if (proxy) then
			proxy._DispatchMessage:Remove(self, UTActivity.Ui.PlayersManagement.OnDispatchMessage)	
		end
	end
...
function UTActivity.Ui.PlayersManagement:OnPlayerRemoved(player)
	...
	--[[for index, proxy in ipairs(engine.libraries.usb.proxies) do
		if (#activity.players < activity.maxNumberOfPlayer) then proxy:Unlock()
		end
	end]]
...
function UTActivity.Ui.PlayersManagement:OnProfileUpdated(slot)
	...
	--[[for index, proxy in ipairs(engine.libraries.usb.proxies) do
		if (#activity.players >= activity.maxNumberOfPlayer) then proxy:Lock()
		end
	end]]
...
function UTActivity.Ui.PlayersManagement:OnOpen()
	...
	for index, proxy in ipairs(engine.libraries.usb.proxies) do
		proxy._DispatchMessage:Add(self, UTActivity.Ui.PlayersManagement.OnDispatchMessage)
	end
