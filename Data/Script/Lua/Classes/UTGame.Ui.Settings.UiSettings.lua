...
function UTGame.Ui.Settings.UiSettings:__ctor()
	...
	UTGame.Ui.Settings.UiSettings.options = {
		...
		[8] = { displayMode = "multiline", tip = l"tip240", label = l"sett036", choices = { { value = 0, displayMode = "large", text = l"oth083" }, { value = 1, displayMode = "large", text = l"oth116" } }, index = "finalranking", },
