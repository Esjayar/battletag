...
function UTActivity.Ui.AdvancedSettings:OnOpen()

	self:Activate()
end

function UTActivity.Ui.AdvancedSettings:OnClose()

	self:Deactivate()
end

function UTActivity.Ui.AdvancedSettings:Save(__self)
...
function UTActivity.Ui.AdvancedSettings:Activate()
...
function UTActivity.Ui.AdvancedSettings:Deactivate()
...
function UTActivity.Ui.AdvancedSettings:KeyDown(virtualKeyCode, scanCode)
