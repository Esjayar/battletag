...
function UTGame.Ui.Settings.GameSettings:__ctor()
	...
	UTGame.Ui.Settings.GameSettings.options = {
	    ...
	    [2] = { displayMode = "multiline", label = l"sett020", choices = { { value = 0, displayMode = "large", text = l"but002", tip = l"tip169" }, { value = 1, displayMode = "large", text = l"but001", tip = l"tip170" } }, index = "playernumbermod", },
	    [3] = { displayMode = "multiline", label = l"sett021", choices = { { value = 0, displayMode = "large", text = l"oth032", tip = l"tip171" }, { value = 1, displayMode = "large", text = l"oth080", tip = l"tip172" } }, index = "unregister", },
	    [4] = { displayMode = "multiline", label = l"sett022", choices = { { value = 0, displayMode = "large", text = l"but002", tip = l"tip173" }, { value = 1, displayMode = "large", text = l"oth080", tip = l"tip174" }, { value = 2, displayMode = "large", text = l"oth032", tip = l"tip193" } }, index = "reconnect", },
		[6] = { displayMode = "multiline", label = l"sett034", choices = { { value = 0, displayMode = "large", text = l"oth080", tip = l"tip237" }, { value = 1, displayMode = "large", text = l"oth032", tip = l"tip238" }, { value = 2, displayMode = "large", text = l"oth076", tip = l"tip237" } }, index = "vestdisconnect", },
