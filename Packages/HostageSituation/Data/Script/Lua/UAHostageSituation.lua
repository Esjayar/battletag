...
UTClass.UAHostageSituation(UTActivity)

-- state dependencies

UAHostageSituation.State = {}

	require "UAHostageSituation.State.RoundLoop"

-- default

UAHostageSituation.bitmap = "base:texture/ui/loading_HostageSituation.tga"

-- __ctor --------------------------------------------------------------------

function UAHostageSituation:__ctor(...)

	-- activity name

    self.name = l"title022"
    self.category = UTActivity.categories.closed
    self.teamdefaults = true
    self.handicap = true

    self.dontDisplayScore = true
	self.textScoring = l"score015"
    self.textRules = l"rules017"
    self.iconBanner = "base:texture/ui/Ranking_Bg_HostageSituation.tga"
    ...
    self.settings = {
        ...
        [1] = { title = l"titlemen006", options = {
            ...
            [1] = { displayMode = nil, label = l"goption001", tip = l"tip027", choices = { { value = 2 }, { value = 5 }, { value = 10 }, { value = 15 }, { value = 20 }, { value = 25 }, { value = 30 } }, index = "playtime", },
            ...
            [4] = { label = l"goption022", tip = l"tip244", choices = { { value = -1, displayMode = "medium", text = l"oth076" }, { value = 0}, { value = 10 }, { value = 20 }, { value = 30 } }, index = "timeleft" },
            [5] = { label = l"goption034", tip = l"tip246", choices = { { value = 1 }, { value = 2 } }, index = "defendingteam" },
            [6] = { displayMode = nil, label = l"goption036", tip = l"tip153", choices = { { value = 0, displayMode = "medium", text = l"oth086" }, { value = 1, displayMode = "medium", text = l"oth087" } }, index = "endgamemode", },
    ...
    self.playground = {
        ...
        [1] = { 
            ...
            RF03 = { priority = 1, title = l"oth056" ..  " (" .. l"oth027" .. ")", text = string.format(l"psexp052"), positions = { { 50, 50 }, }, },
            RF04 = { priority = 2, title = l"oth057" ..  " (" .. l"oth028" .. ")", text = string.format(l"psexp053"), positions = { { 480, 50 }, }, },            
            RF05 = { priority = 3, title = l"oth058" ..  " (" .. l"oth029" .. ")", text = string.format(l"psexp043"), positions = { { 480, 250 }, }, },
    ...
    self.states["roundloop"] = UAHostageSituation.State.RoundLoop:New(self)
...
function UAHostageSituation:__dtor()
end

-- InitEntityBakedData  ------------------------------------------------------

function UAHostageSituation:InitEntityBakedData(entity, ranking)
...
function UAHostageSituation:InitEntityHeapData(entity, ranking)
...
function UAHostageSituation:UpdateEntityBakedData(entity, ranking)
