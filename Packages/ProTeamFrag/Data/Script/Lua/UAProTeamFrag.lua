...
UTClass.UAProTeamFrag(UTActivity)

-- state dependencies

UAProTeamFrag.State = {}

	require "UAProTeamFrag.State.RoundLoop"

-- default

UAProTeamFrag.bitmap = "base:texture/ui/loading_proteamfrag.tga"

-- __ctor --------------------------------------------------------------------

function UAProTeamFrag:__ctor(...)

	-- activity name

    self.name = l"title018"
    ...
    self.settings = {
        ...
        [3] = { title = l"titlemen023", options = {
            ...
            [2] = { label = l"goption017", tip = l"tip127", choices = { { value = 2 }, { value = 3 }, { value = 4 }, { value = 5 }, { value = 7 }, { value = 9 }, { value = 12 }, { value = 15 }, { value = 0, text = "", icon = "base:texture/ui/components/uiradiobutton_infinity.tga" } }, index = "lives", },
            [3] = { label = l"goption012", tip = l"tip036", choices = { { value = 0 }, { value = 5 }, { value = 10 }, { value = 12 }, { value = 15 }, { value = 20 } }, index = "respawnTime", },
            [4] = { label = l"goption018", tip = l"tip129", choices = { { value = 0, displayMode = "medium", text = l"oth076"}, { value = 2 }, { value = 3 }, { value = 4 }, { value = 5 } }, index = "shield" },
    ...
    self.states["roundloop"] = UAProTeamFrag.State.RoundLoop:New(self)
...
function UAProTeamFrag:__dtor()
end

-- InitEntityBakedData  ------------------------------------------------------

function UAProTeamFrag:InitEntityBakedData(entity, ranking)
...
function UAProTeamFrag:InitEntityHeapData(entity, ranking)
	...
	if (entity:IsKindOf(UTTeam)) then
		...
		entity.data.heap.shield = activity.settings.shield
...
function UAProTeamFrag:UpdateEntityBakedData(entity, ranking)
