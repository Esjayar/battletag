...
UAFreeForAll.Ui = UAFreeForAll.Ui or {}
UAFreeForAll.Ui.RoundLoop = UTClass(UIMenuPage)

-- __ctor -------------------------------------------------------------------

function UAFreeForAll.Ui.RoundLoop:__ctor(...)
...
function UAFreeForAll.Ui.RoundLoop:__dtor()    
end

-- Update -------------------------------------------------------------------

function UAFreeForAll.Ui.RoundLoop:Update()
end
