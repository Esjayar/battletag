...
UATeamFrag.Ui = UATeamFrag.Ui or {}
UATeamFrag.Ui.RoundLoop = UTClass(UIMenuPage)

-- __ctor -------------------------------------------------------------------

function UATeamFrag.Ui.RoundLoop:__ctor(...)
...
function UATeamFrag.Ui.RoundLoop:__dtor()    
...
function UATeamFrag.Ui.RoundLoop:Update()
end
