...
UATeamFrag.bytecodePath = "game:../packages/teamfrag/data/script/bytecode/UATeamFrag.ByteCode.lua"
...
function UATeamFrag:__ctor(...)
    ...
    self.settings = {
        ...
        [1] = { title = l"titlemen006", options = {
            ...
            [1] = { displayMode = nil, label = l"goption001", tip = l"tip027", choices = { { value = 5 }, { value = 10 }, { value = 15 }, { value = 20 } }, index = "playtime", },
