...
function UARustlers:__ctor(...)
    ...
    self.settings = {
        ...
        [1] = { title = l"titlemen006", options = {
            ...
            [1] = { displayMode = nil, label = l"goption008", tip = l"tip113", choices = { { value = 2 } }, index = "numberOfTeams", },
        ...
        [2] = { title = l"titlemen007", options = {
           ...
           -- [3] = { label = l"goption011", choices = { { value = 0, displayMode = "medium", text = "Auto" } }, index = "respawnMode", },
            ...
            [5] = { label = l"goption017", tip = l"tip127", choices = { { value = 2 }, { value = 3 }, { value = 4 }, { value = 5 }, { value = 7 }, { value = 9 }, { value = 12 }, { value = 15 }, { value = 0, text = "", icon = "base:texture/ui/components/uiradiobutton_infinity.tga" } }, index = "lives", },
    ...
    self.playground = {
        ...
        [1] = { 
            ...
            RF03 = { priority = 1, title = l"oth056" ..  " (" .. l"oth027" .. ")", text = string.format(l"psexp027"), positions = { { 50, 50 }, }, condition = function (self) return (0 == activity.settings.respawnmode) end },
            RF04 = { priority = 2, title = l"oth057" ..  " (" .. l"oth028" .. ")", text = string.format(l"psexp028"), positions = { { 480, 50 }, }, condition = function (self) return (0 == activity.settings.respawnmode) end },
