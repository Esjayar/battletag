...
--[[--------------------------------------------------------------------------
--
-- File:            UATeamTagThenShoot.Ui.RoundLoop.lua
...
UATeamTagThenShoot.Ui.RoundLoop = UTClass(UIMenuPage)

-- __ctor -------------------------------------------------------------------

function UATeamTagThenShoot.Ui.RoundLoop:__ctor(...)
...
function UATeamTagThenShoot.Ui.RoundLoop:__dtor()    
end

-- Onclose --------------------------------------------------------------------

function UATeamTagThenShoot.Ui.RoundLoop:OnClose()
...
function UATeamTagThenShoot.Ui.RoundLoop:OnOpen()
...
function UATeamTagThenShoot.Ui.RoundLoop:OnDataChanged(_entity, _key, _value)
