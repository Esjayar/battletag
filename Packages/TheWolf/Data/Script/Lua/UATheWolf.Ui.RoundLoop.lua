...
--[[--------------------------------------------------------------------------
--
-- File:            UATheWolf.Ui.RoundLoop.lua
...
require "UTActivity.Ui.RoundLoop"
	...
	require "UATheWolf.UILeaderboardItem"

--[[ Class -----------------------------------------------------------------]]

UATheWolf.Ui = UATheWolf.Ui or {}
UATheWolf.Ui.RoundLoop = UTClass(UIMenuPage)

-- __ctor -------------------------------------------------------------------

function UATheWolf.Ui.RoundLoop:__ctor(...)
    ...
    self.uiLeaderboard.uiItem = UATheWolf.UILeaderboardItem
    self.uiLeaderboard:Build(activity.match.challengers, "heap")
end

-- __dtor -------------------------------------------------------------------

function UATheWolf.Ui.RoundLoop:__dtor()    
end