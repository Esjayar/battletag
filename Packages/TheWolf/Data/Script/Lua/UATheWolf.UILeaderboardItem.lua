...
--[[--------------------------------------------------------------------------
--
-- File:            UATheWolf.UILeaderboardItem.lua
...
UATheWolf.UILeaderboardItem = UTClass(UILeaderboardItem)

-- __ctor ------------------------------------------------------------------

function UATheWolf.UILeaderboardItem:__ctor(leaderboard, challenger)

end

-- Draw --------------------------------------------------------------------

function UATheWolf.UILeaderboardItem:Draw()
