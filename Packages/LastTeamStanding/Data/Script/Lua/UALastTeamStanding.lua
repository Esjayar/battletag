...
UTClass.UALastTeamStanding(UTActivity)

-- state dependencies

UALastTeamStanding.State = {}

	require "UALastTeamStanding.State.RoundLoop"
...
function UALastTeamStanding:__ctor(...)
    ...
    self.textRules = l"rules012"
    self.iconBanner = "base:texture/ui/Ranking_Bg_LastTeamStanding.tga"
...
function UALastTeamStanding:__dtor()
end

-- InitEntityBakedData  ------------------------------------------------------

function UALastTeamStanding:InitEntityBakedData(entity, ranking)
...
function UALastTeamStanding:InitEntityHeapData(entity, ranking)
	...
	if (entity:IsKindOf(UTTeam)) then
		...
		entity.data.heap.score = #activity.match.challengers
...
function UALastTeamStanding:UpdateEntityBakedData(entity, ranking)
