...
--[[--------------------------------------------------------------------------
--
-- File:            UALastTeamStanding.Ui.RoundLoop.lua
...
UALastTeamStanding.Ui = UALastTeamStanding.Ui or {}
UALastTeamStanding.Ui.RoundLoop = UTClass(UIMenuPage)

-- __ctor -------------------------------------------------------------------

function UALastTeamStanding.Ui.RoundLoop:__ctor(...)
...
function UALastTeamStanding.Ui.RoundLoop:__dtor()    
...
function UALastTeamStanding.Ui.RoundLoop:Update()
end
