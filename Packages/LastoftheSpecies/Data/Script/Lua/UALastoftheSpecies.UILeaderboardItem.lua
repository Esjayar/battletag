...
--[[--------------------------------------------------------------------------
--
-- File:            UALastoftheSpecies.UILeaderboardItem.lua
...
UALastoftheSpecies.UILeaderboardItem = UTClass(UILeaderboardItem)

-- __ctor ------------------------------------------------------------------

function UALastoftheSpecies.UILeaderboardItem:__ctor(leaderboard, challenger)

end

-- Draw --------------------------------------------------------------------

function UALastoftheSpecies.UILeaderboardItem:Draw()
	...
	if (self.challenger.wolf) then
		...
		if (#activity.players <= 8) then 
			quartz.system.drawing.drawtexture(-128, offset - 44, 0, offset + 80)
		else
			quartz.system.drawing.drawtexture(220, -16, 304, 68)
		end
	end		
