...
function UAFreeForAll:__ctor(...)
    ...
    self.settings = {
        ...
        [1] = { title = l"titlemen006", options = {
            ...
            [1] = { displayMode = nil, label = l"goption007", tip = l"tip040", choices = { { value = 0, displayMode = "medium", text = l"oth076" }, { value = 1, displayMode = "medium", text = l"oth082" }, { value = 2, displayMode = "medium", text = l"oth075" } }, index = "swap", },
        ...
        [2] = { title = l"titlemen007", options = {
          ...
          --  [2] = { label = l"goption011", choices = { { value = 0, displayMode = "medium", text = "Auto" } }, index = "respawnMode", },
            [3] = { label = l"goption005", tip = l"tip032", choices = { { value = 1 }, { value = 2 }, { value = 3 }, { value = 4 }, { value = 5 }, { value = 6 } }, index = "clips", },
            [4] = { label = l"goption017", tip = l"tip127", choices = { { value = 3 }, { value = 5 }, { value = 7 }, { value = 9 }, { value = 15 }, { value = 0, text = "", icon = "base:texture/ui/components/uiradiobutton_infinity.tga" } }, index = "lives", },
            [5] = { label = l"goption011", tip = l"tip128", choices = { { value = 0, text = "", icon = "base:texture/ui/components/uiradiobutton_tbase.tga" }, { value = 1, displayMode = "medium", text = l"oth080" } }, index = "respawnmode", },
            [6] = { label = l"goption006", tip = l"tip033", choices = { { value = 1 }, { value = 2 }, { value = 3 }, { value = 4 }, { value = 5 }, { value = 6 }, { value = 7 }, { value = 8 }, { value = 9 }, { value = 10 } }, index = "lifePoints", },
