...
UTClass.UAKingoftheHill(UTActivity)

-- state dependencies

UAKingoftheHill.State = {}

	require "UAKingoftheHill.State.RoundLoop"

-- default

UAKingoftheHill.bitmap = "base:texture/ui/loading_KingoftheHill.tga"

-- __ctor --------------------------------------------------------------------

function UAKingoftheHill:__ctor(...)

	-- activity name

    self.name = l"title023"
    self.category = UTActivity.categories.closed
    self.teamdefaults = true
    self.handicap = true

    self.textScoring = l"score016"
    self.textRules = l"rules018"
    self.iconBanner = "base:texture/ui/Ranking_Bg_KingoftheHill.tga"
    ...
    self.settings = {
        ...
        [1] = { title = l"titlemen006", options = {
            ...
            [4] = { displayMode = nil, label = l"goption001", tip = l"tip027", choices = { { value = 5 }, { value = 10 }, { value = 15 }, { value = 20 }, { value = 25 }, { value = 30 } }, index = "playtime", },
            [5] = { displayMode = nil, label = l"goption037", tip = l"tip161", choices = { { value = 0, displayMode = "medium", text = l"oth076" }, { value = 1 }, { value = 2 }, { value = 3 }, { value = 4 }, { value = 5 } }, index = "hillbonus", },
            [6] = { displayMode = nil, label = l"goption038", tip = l"tip162", choices = { { value = 0, displayMode = "medium", text = l"oth076" }, { value = 1, displayMode = "medium", text = l"oth075" } }, index = "hitscoring", },
            [7] = { displayMode = nil, label = l"goption039", tip = l"tip163", choices = { { value = 1 }, { value = 2 }, { value = 3 }, { value = 4 }, { value = 5 }, { value = 6 } }, index = "interval", },
            [8] = { displayMode = nil, label = l"goption040", tip = l"tip164", choices = { { value = 0, displayMode = "medium", text = l"oth076" }, { value = 3 }, { value = 5 }, { value = 10 }, { value = 15 }, { value = 20 } }, index = "hilldelay", },
        ...
        [3] = { title = l"titlemen022", options = {
            ...
            [1] = { label = l"goption011", tip = l"tip128", choices = { { value = 0, conditional = true, text = "", icon = "base:texture/ui/components/uiradiobutton_tbase.tga" }, { value = 1, displayMode = "medium", text = l"oth080" } }, index = "respawnmode", condition = function (self) return (1 == game.settings.addons.customPack or activity.settings.numberOfTeams < 4 and 1 == game.settings.addons.medkitPack) end },
            [2] = { displayMode = nil, label = l"goption041", tip = l"tip195", choices = { { value = 0, displayMode = "medium", text = l"oth076" }, { value = 1, displayMode = "medium", text = l"oth075" } }, index = "respawnhit", },
            [3] = { label = l"goption012", tip = l"tip036", choices = { { value = 0 }, { value = 5 }, { value = 10 }, { value = 12 }, { value = 15 }, { value = 20 } }, index = "respawntime", },
            [4] = { displayMode = nil, label = l"goption028", tip = l"tip165", choices = { { value = 0, displayMode = "medium", text = l"oth076" }, { value = 20 }, { value = 30 }, { value = 40 }, { value = 50 }, { value = 60 } }, index = "respawntimer", },
            [5] = { label = l"goption017", tip = l"tip127", choices = { { value = 3 }, { value = 5 }, { value = 9 }, { value = 12 }, { value = 15 }, { value = 0, text = "", icon = "base:texture/ui/components/uiradiobutton_infinity.tga" } }, index = "lives", },
    ...
    self.playground = {
        ...
        [2] = { 
            ...
            RF05 = { priority = 3, title = l"oth058" ..  " (" .. l"oth098" .. ")", text = string.format(l"psexp038"), positions = { { 265, 150 }, }, condition = function (self) return (0 == activity.settings.respawnmode) end },
            RF10 = { priority = 4, title = l"oth097" ..  " (" .. l"oth098" .. ")", text = string.format(l"psexp041"), positions = { { 265, 150 }, }, condition = function (self) return (1 == activity.settings.respawnmode) end },
        ...
        [3] = { 
            ...
            RF06 = { priority = 4, title = l"oth059" ..  " (" .. l"oth098" .. ")", text = string.format(l"psexp039"), positions = { { 265, 150 }, }, condition = function (self) return (0 == activity.settings.respawnmode) end },
            RF10 = { priority = 5, title = l"oth097" ..  " (" .. l"oth098" .. ")", text = string.format(l"psexp041"), positions = { { 265, 150 }, }, condition = function (self) return (1 == activity.settings.respawnmode) end },
        ...
        [4] = { 
            ...
            RF13 = { priority = 5, title = l"oth097" ..  " (" .. l"oth098" .. ")", text = string.format(l"psexp040"), positions = { { 265, 150 }, }, condition = function (self) return (0 == activity.settings.respawnmode) end },
            RF10 = { priority = 6, title = l"oth097" ..  " (" .. l"oth098" .. ")", text = string.format(l"psexp041"), positions = { { 265, 150 }, }, condition = function (self) return (1 == activity.settings.respawnmode) end },
            RF07 = { category = "Med-Kit", title = l"goption009", text = string.format(l"psexp015"), positions = { { 330, 100 }, }, condition = function (self) return (1 == game.settings.addons.medkitPack) end },
            RF08 = { category = "Med-Kit2", title = l"goption009", text = string.format(l"psexp015"), positions = { { 200, 200 }, }, condition = function (self) return (1 == game.settings.addons.medkitPack) end },
        },
        ...
        [5] = { 
            ...
            RF13 = { priority = 6, title = l"oth097" ..  " (" .. l"oth098" .. ")", text = string.format(l"psexp040"), positions = { { 265, 150 }, }, condition = function (self) return (0 == activity.settings.respawnmode) end },
            RF10 = { priority = 7, title = l"oth097" ..  " (" .. l"oth098" .. ")", text = string.format(l"psexp041"), positions = { { 265, 150 }, }, condition = function (self) return (1 == activity.settings.respawnmode) end },
            RF07 = { category = "Med-Kit", title = l"goption009", text = string.format(l"psexp015"), positions = { { 330, 100 }, }, condition = function (self) return (1 == game.settings.addons.medkitPack) end },
            RF08 = { category = "Med-Kit2", title = l"goption009", text = string.format(l"psexp015"), positions = { { 200, 200 }, }, condition = function (self) return (1 == game.settings.addons.medkitPack) end },
        },
        ...
        [6] = { 
            ...
            RF13 = { priority = 7, title = l"oth097" ..  " (" .. l"oth098" .. ")", text = string.format(l"psexp040"), positions = { { 265, 150 }, }, condition = function (self) return (0 == activity.settings.respawnmode) end },
            RF10 = { priority = 8, title = l"oth097" ..  " (" .. l"oth098" .. ")", text = string.format(l"psexp041"), positions = { { 265, 150 }, }, condition = function (self) return (1 == activity.settings.respawnmode) end }, 
            RF07 = { category = "Med-Kit", title = l"goption009", text = string.format(l"psexp015"), positions = { { 330, 100 }, }, condition = function (self) return (1 == game.settings.addons.medkitPack) end },
            RF08 = { category = "Med-Kit2", title = l"goption009", text = string.format(l"psexp015"), positions = { { 200, 200 }, }, condition = function (self) return (1 == game.settings.addons.medkitPack) end },
        },
    }
    ...
    self.states["roundloop"] = UAKingoftheHill.State.RoundLoop:New(self)
...
function UAKingoftheHill:__dtor()
end

-- InitEntityBakedData  ------------------------------------------------------

function UAKingoftheHill:InitEntityBakedData(entity, ranking)
...
function UAKingoftheHill:InitEntityHeapData(entity, ranking)
	...
	if (entity:IsKindOf(UTTeam)) then
		...
		entity.data.heap.nbHillPlayerAlive = #entity.players
		entity.data.heap.hillpointsearned = 0
		entity.data.heap.hillpointssaved = 0
		entity.data.heap.scorebackup = 0
		...
		entity.data.heap.hitscoring = activity.settings.hitscoring
		entity.data.heap.hillbonus = activity.settings.hillbonus
		entity.data.heap.interval = activity.settings.interval
		entity.data.heap.hilldelay = activity.settings.hilldelay
		entity.data.heap.respawntimer = activity.settings.respawntimer
		entity.data.heap.respawnhit = activity.settings.respawnhit
...
function UAKingoftheHill:UpdateEntityBakedData(entity, ranking)
