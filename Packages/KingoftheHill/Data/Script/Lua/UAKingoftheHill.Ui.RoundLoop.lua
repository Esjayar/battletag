...
UAKingoftheHill.Ui = UAKingoftheHill.Ui or {}
UAKingoftheHill.Ui.RoundLoop = UTClass(UIMenuPage)

-- __ctor -------------------------------------------------------------------

function UAKingoftheHill.Ui.RoundLoop:__ctor(...)
...
function UAKingoftheHill.Ui.RoundLoop:__dtor()    
...
function UAKingoftheHill.Ui.RoundLoop:Update()
end
