...
--[[--------------------------------------------------------------------------
--
-- File:			UATeamBaseShoot_FreeForAll.lua
...
UTClass.UATeamBaseShoot(UTActivity)

-- state dependencies

UATeamBaseShoot.State = {}

	require "UATeamBaseShoot.State.RoundLoop"

-- default

UATeamBaseShoot.bitmap = "base:texture/ui/loading_TeamBaseShoot.tga"

-- __ctor --------------------------------------------------------------------

function UATeamBaseShoot:__ctor(...)

	-- activity name

    self.name = l"title030"
    ...
    self.iconBanner = "base:texture/ui/Ranking_Bg_TeamBaseShoot.tga"
    ...
    self.settings = {
        ...
        [2] = { title = l"titlemen021", options = {
            ...
            [1] = { label = l"goption004", tip = l"tip028", choices = { { value = 6 }, { value = 9 }, { value = 12 }, { value = 15 }, { value = 18 }, { value = 254, text = "", icon = "base:texture/ui/components/uiradiobutton_infinity.tga" } }, index = "ammunitions", },
    ...
    self.states["roundloop"] = UATeamBaseShoot.State.RoundLoop:New(self)
...
function UATeamBaseShoot:__dtor()
end

-- InitEntityBakedData  ------------------------------------------------------

function UATeamBaseShoot:InitEntityBakedData(entity, ranking)
...
function UATeamBaseShoot:InitEntityHeapData(entity, ranking)
...
function UATeamBaseShoot:UpdateEntityBakedData(entity, ranking)
	...
	if (entity:IsKindOf(UTTeam)) then
		...
		--[[for i, proxy in ipairs(engine.libraries.usb.proxies) do
			proxy.base = i
		end]]
