...
--[[--------------------------------------------------------------------------
--
-- File:            UATeamBaseShoot.Ui.RoundLoop.lua
...
UATeamBaseShoot.Ui = UATeamBaseShoot.Ui or {}
UATeamBaseShoot.Ui.RoundLoop = UTClass(UIMenuPage)

-- __ctor -------------------------------------------------------------------

function UATeamBaseShoot.Ui.RoundLoop:__ctor(...)
...
function UATeamBaseShoot.Ui.RoundLoop:__dtor()    
...
function UATeamBaseShoot.Ui.RoundLoop:Update()
end
